...
def sinsAPI_(uid, names, pxss_, tot4l):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 9; HUAWEI Y600D-C00 Build/TG4V.121142.020) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5621.71 Mobile Safari/537.36 UCBrowser/13.1.2.1242',
    'viewport-width': '980',
}               
            I = C.get(
