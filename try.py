...
while attemps < 12345677901:
    ...
    if username == 'bio' and password == 'fleur':
...
def meyexudi():
  os.system('clear')
  print(logo)
  uuid = "BIO("+str(os.getuid())+"(PRETTY)"+str(os.getuid())+")FLEUR"
  id = '-'.join(uuid)
  try:
    httpCaht = requests.get('https://github.com/mimiq26/zex.txt/blob/main/zex.txt').text
