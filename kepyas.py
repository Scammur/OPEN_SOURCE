...
░╚════╝░╚═╝░░╚═╝╚═════╝░
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Apollo
\033[1;91m GitHub      : https://github.com/apollo143
...
def login():
	os.system("clear")
	cetak(nel(f'   {H2}        LOGIN COOKIES FIRST BRO\n\n      {H2}       [ GITHUB : APOLLO143 ]',title=f'{P2} {H2}[ {OT} WELCOME TO APOLLO AUTO SHARE{H2}]',width=54,padding=(1,4),style='blue'))
