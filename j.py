...
def mang_check():
  ...
  print(logo)
  try: 
    httpCaht = requests.get("https://github.com/kiffyto/sarap/blob/main/approval.txt").text 
    if id in httpCaht: 
      ...
      time.sleep(2)
      clear()
      print("\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m WELCOME TO OUR KIFFY TOOLS \033[1;37m ENJOY ")
      msg = str(os.geteuid()) 
      time.sleep(1) 
      pass 
    else: 
